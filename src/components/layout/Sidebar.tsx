    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-white/10 bg-[#0a0a0b]/80 backdrop-blur-xl hidden md:block">
      <div className="flex h-full flex-col px-4 py-6">
        <Link href="/" className="mb-8 flex items-center px-2 cursor-pointer">
          <div className="h-8 w-8 rounded-lg bg-premium-gradient flex items-center justify-center shadow-[0_0_15px_rgba(139,92,246,0.5)]">
        ...
        <div className="mt-auto border-t border-white/10 pt-6">
          {user && (
            <div className="flex items-center gap-3 px-3 py-2.5 mb-4 rounded-xl bg-white/5 border border-white/5">
              <div className="h-9 w-9 rounded-full bg-premium-gradient flex items-center justify-center text-sm font-bold text-white shadow-[0_0_10px_rgba(139,92,246,0.3)]">
          ...
          <Link href="/settings">
            <div className="group flex items-center rounded-xl px-3 py-2.5 text-sm font-medium text-gray-400 transition-all hover:bg-white/5 hover:text-white cursor-pointer">
              <Settings className="mr-3 h-5 w-5 text-gray-500 group-hover:text-gray-300" />
              Settings
            </div>
          </Link>
          <button onClick={handleLogout} className="group mt-2 flex w-full items-center rounded-xl px-3 py-2.5 text-sm font-medium text-gray-400 transition-all hover:bg-red-500/10 hover:text-red-400">
